...
img1 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B1.jpeg', 0)
img2 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B2.jpeg', 0)
img3 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B3.jpeg', 0)
img4 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B4.jpeg', 0)
img5 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B5.jpeg', 0)
img6 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B6.jpeg', 0)
img7 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B7.jpeg', 0)
img8 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B8.jpeg', 0)
img8A = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B8A.jpeg', 0)
img9 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B9.jpeg', 0)
img11 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B11.jpeg', 0)
img12 = cv.imread('../dataset/LOW_HAB/22_08_2020/images/narroBand/B12.jpeg', 0)



# HAB PIXELS

Aug_2020_HAB_5K = []    # HAB pixels for Aug_2020
Aug_2020_HAB_5K_features = []
file1 = open('./pixels5k/Aug_2020_HAB_5K.csv')
csvreader1 = csv.reader(file1)
for row in csvreader1:
    class_number = 1    # HAB == 1
    row = [int(row[0]), int(row[1])]
    Aug_2020_HAB_5K.append(row)
    feature_vector = []
    ...
    Aug_2020_HAB_5K_features.append(feature_vector)


# Load to CSV
with open('./numerical_dataset/Aug_2020_HAB.csv', 'w', newline='') as f:
    write = csv.writer(f)
    write.writerow(features)
    write.writerows(Aug_2020_HAB_5K_features)
...
Aug_2020_NO_HAB_5K = []    # NO_HAB pixels for Aug_2020
Aug_2020_NO_HAB_5K_features = []
file2 = open('./pixels5k/Aug_2020_NO_HAB_5K.csv')
csvreader2 = csv.reader(file2)
for row in csvreader2:
    class_number = 0    # NO_HAB == 0
    row = [int(row[0]), int(row[1])]
    Aug_2020_NO_HAB_5K.append(row)
    feature_vector = []
    B01 = img1[row[0]][row[1]]
    feature_vector.append(B01)
    B02 = img2[row[0]][row[1]]
    ...
    feature_vector.append(RD3)
    feature_vector.append(class_number)
    Aug_2020_NO_HAB_5K_features.append(feature_vector)


# Load to CSV
with open('./numerical_dataset/Aug_2020_NO_HAB.csv', 'w', newline='') as f:
    write = csv.writer(f)
    write.writerow(features)
    write.writerows(Aug_2020_NO_HAB_5K_features)
